                        ...
                        <% loop $Children %>
                            <div class="item col-md-6">
                                ...
                                <div class="info-blog">
                                    ...
                                    <p>Sed rutrum urna id tellus euismod gravida. Praesent placerat, mauris ac pellentesque
                                        fringilla, tortor libero condimen. Aliquam fermem tum nulla felis, sed molestie
                                        libero porttitor in.</p>
                                </div>
                            </div>
                        <% end_loop %>
                    </div>
